...
export async function setupVoiceOpenAI({ client, guildId, voiceChannelId, openAIApiKey, log, voice, volume, mcpClients, allTools, mcpTools }) {
    ...
    const playback = createAudioPlayback(audioPlayer, volume);
